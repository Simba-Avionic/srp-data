...
from gif_maker import generate_gif_frames, create_gif_from_frames

INPUT_FILE = "static3_FIRE_wyciety_test.txt"
OUTPUT_FILE = "XD.png"

ENG_OUTPUT_FILE = "XD.eng"
...
avg_thrust_not_filtered = 0.0
avg_thrust_srednia_kroczaca = 0.0
avg_thrust_savgol = 0.0
...
if GENERATE_GIF:
    ...
    generate_gif_frames(x_values_micros, y_values, y_values_savgol, impuls_values, fps=60, output_dir="frames")
